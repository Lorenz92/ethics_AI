        ...
        \begin{column}{0.6\linewidth}
            \begin{itemize}
                ...
                \item What would happen to the chosen characters?
                      \begin{itemize}
                          \item \emoji{skull-and-crossbones}  $\rightarrow$ death
                          \item \emoji{face-with-head-bandage} $\rightarrow$ injury
                          \item \emoji{question-mark} $\rightarrow$ unknown
                      \end{itemize}
            \end{itemize}
        \end{column}
...
\begin{frame}[plain, noframenumbering]
    \centering
    \vfill
    {\usebeamerfont{title} Thanks for the attention}
    \vfill
\end{frame}
